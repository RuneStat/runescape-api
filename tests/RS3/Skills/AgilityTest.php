...
class AgilityTest extends TestCase
{
    protected ?Agility $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Agility();
    }
    ...
    {
        $this->assertSame(17, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('agility', $this->skill->getName());
    }
