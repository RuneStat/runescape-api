...
class FarmingTest extends TestCase
{
    protected ?Farming $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Farming();
    }
    ...
    {
        $this->assertSame(20, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('farming', $this->skill->getName());
    }
