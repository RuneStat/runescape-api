...
class SlayerTest extends TestCase
{
    protected ?Slayer $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Slayer();
    }
    ...
    {
        $this->assertSame(19, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('slayer', $this->skill->getName());
    }
