...
class RunecraftingTest extends TestCase
{
    protected ?Runecrafting $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Runecrafting();
    }
    ...
    {
        $this->assertSame(21, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('runecrafting', $this->skill->getName());
    }
