...
class DungeoneeringTest extends TestCase
{
    protected ?Dungeoneering $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Dungeoneering();
    }
    ...
    {
        $this->assertSame(25, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('dungeoneering', $this->skill->getName());
    }
