...
class FishingTest extends TestCase
{
    protected ?Fishing $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Fishing();
    }
    ...
    {
        $this->assertSame(11, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('fishing', $this->skill->getName());
    }
