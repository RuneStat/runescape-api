...
class FletchingTest extends TestCase
{
    protected ?Fletching $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Fletching();
    }
    ...
    {
        $this->assertSame(10, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('fletching', $this->skill->getName());
    }
