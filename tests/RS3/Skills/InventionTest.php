...
class InventionTest extends TestCase
{
    ...
    {
        $this->assertSame(27, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('invention', $this->skill->getName());
    }
    ...
    {
        $this->assertSame(150, $this->skill->getMaxVirtualLevel());
    }
    ...
    {
        $this->assertTrue($this->skill->isElite());
    }
}
