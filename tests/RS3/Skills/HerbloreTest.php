...
class HerbloreTest extends TestCase
{
    protected ?Herblore $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Herblore();
    }
    ...
    {
        $this->assertSame(16, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('herblore', $this->skill->getName());
    }
