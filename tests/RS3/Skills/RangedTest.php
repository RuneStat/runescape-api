...
class RangedTest extends TestCase
{
    protected ?Ranged $skill;

    public function setUp(): void
    {
        parent::setUp();

        $this->skill = new Ranged();
    }
    ...
    {
        $this->assertSame(5, $this->skill->getId());
    }

    /** @test */
    public function it_should_return_a_skill_name(): void
    {
        $this->assertSame('ranged', $this->skill->getName());
    }
